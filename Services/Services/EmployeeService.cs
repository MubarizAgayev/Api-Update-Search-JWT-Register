...
namespace Services.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task UpdateAsync(EmployeeEditDto newEmployee,int? id)
        {
            ...
            if (existEmployee != null) throw new NullReferenceException();

            _mapper.Map(newEmployee, existEmployee);

            await _employeeRepo.UpdateAsync(existEmployee);
        }

        public async Task<IEnumerable<EmployeeDto>> Search(string? searchText)
        {
